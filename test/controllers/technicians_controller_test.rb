...
class TechniciansControllerTest < ActionController::TestCase
  ...
  test "should create technician" do
    assert_difference('Technician.count') do
      post :create, technician: { location: @technician.location, name: @technician.name, techid: @technician.techid }
    end
  ...
  test "should update technician" do
    patch :update, id: @technician, technician: { location: @technician.location, name: @technician.name, techid: @technician.techid }
    assert_redirected_to technician_path(assigns(:technician))
  end
